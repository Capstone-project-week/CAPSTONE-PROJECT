...
import { StoryService, StoryDto } from '../../../core/services/story.service';
...
export class MyStoriesComponent implements OnInit {
  ...
  activeFilter: 'all' | 'draft' | 'published' = 'all';

  ngOnInit() {
    this.storyService.getUserStories().subscribe({
      next: (backendStories) => {
        const mappedStories: Story[] = backendStories.map(s => ({
        ...
        // Prepend backend stories to the hardcoded ones
        this.stories = [...mappedStories, ...this.stories];
